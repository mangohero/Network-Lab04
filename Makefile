all: son/son sip/sip client/app_simple_client server/app_simple_server client/app_stress_client server/app_stress_server IM_client/IM_client IM_server/IM_server
...
IM_client/IM_client:IM_client/client.c common/seg.o client/stcp_client.o topology/topology.o 
	gcc -Wall -pedantic -std=c99 -g -pthread IM_client/client.c common/seg.o client/stcp_client.o topology/topology.o -o IM_client/IM_client
IM_server/IM_server:IM_client/client.c  common/seg.o server/stcp_server.o topology/topology.o 
	gcc -Wall -pedantic -std=c99 -g -pthread IM_server/server.c common/seg.o server/stcp_server.o topology/topology.o -o IM_server/IM_server
clean:
	rm -rf common/*.o
	rm -rf topology/*.o
	rm -rf son/*.o
	...
	rm -rf IM_client/*.o
	rm -rf IM_client/IM_client
	rm -rf IM_server/*.o
	rm -rf IM_server/IM_server
	rm -rf */*~
	rm -rf *~
